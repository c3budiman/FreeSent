          ...
          <div class="card-box">
              ...
              <form enctype="multipart/form-data" action="{{url(action("WebAdminController@updateJudulDanSlogan"))}}" method="post" class="form-horizontal ">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-9">
                          <input name="judul" type="text" required class="form-control" value="{{DB::table('setting_situses')->where('id','=','1')->get()->first()->namaSitus}}">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-3 col-form-label">Slogan : </label>
                      <div class="col-9">
                          <textarea name="slogan" rows="8" cols="80" class="form-control">{{DB::table('setting_situses')->where('id','=','1')->get()->first()->slogan}}</textarea>
                      </div>
                  </div>
                  <div class="form-group row">
                      <div class="col-12">
